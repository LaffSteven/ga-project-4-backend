...
SECRET_KEY = 'django-insecure-1*pr=g@coiv)@q#wa=7z6$xb$j7y=ok)1=_hcxt6&s+it7v7)c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'ga-bookstore-backend.herokuapp.com']
...
# )
>>>>>>> 5eccbd588ffffd963cb6435dfcbc6c7e7e24afaa
